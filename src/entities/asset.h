...
#define MC_ENT_MAX_SCRIPT_SIZE                  367001600
#define MC_ENT_MAX_FIXED_FIELDS_SIZE                  128 
#define MC_ENT_MAX_STORED_ISSUERS                     128 
#define MC_ENT_SCRIPT_ALLOC_SIZE                367005184 // > MC_ENT_MAX_SCRIPT_SIZE + MC_ENT_MAX_FIXED_FIELDS_SIZE + 27*MC_ENT_MAX_STORED_ISSUERS
