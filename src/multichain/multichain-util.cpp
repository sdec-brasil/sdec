...
*/        
    ...
    if(err == MC_ERR_OPERATION_NOT_SUPPORTED)
    {
        ...
        printf("Usage:\n");
        printf("  sdec-util create <blockchain-name>  ( <protocol-version> = %d ) [options]        Creates new multichain configuration file %s with default parameters\n",
        ...
        printf("  sdec-util clone <old-blockchain-name> <new-blockchain-name> [options]               Creates new multichain configuration file %s copying parameters\n",fileName);
